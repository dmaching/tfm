...
Los tres modelos utilizan los mismos retornos escalados, las primeras 2.212 filas como entrenamiento y las 554 finales como test. Se fijan semilla 42, 120 épocas, lotes de 64, Adam con tasa $10^{-3}$ y dos capas ocultas de 64 unidades. Cada candidato genera 5.000 escenarios. La ejecución en CPU usa \texttt{compare\_autoencoders.py} y guarda un CSV comparativo.
...
La ventaja reconstructiva del AE sugiere, no obstante, que futuras evaluaciones deberían construir también una cartera con sus escenarios y repetir ambos modelos con varias semillas. La selección del VAE es coherente con el objetivo y la trazabilidad del experimento, pero queda condicionada por la limitada búsqueda de hiperparámetros y no equivale a demostrar que sea la mejor arquitectura posible.
