...
El preprocesamiento descarta activos cuya proporción de ausencias supere el 5~\% y aplica propagación hacia delante antes de calcular retornos. Después de alinear las series y eliminar la primera fila indefinida, los 30 activos conservados presentan cero valores ausentes en las 2.766 observaciones. La Figura~\ref{fig:eda_missing_values} muestra este resultado para cada columna.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{figuras/eda/missing_values_by_asset.png}
\caption{Valores perdidos por activo en la matriz final de retornos. Fuente: elaboración propia a partir de los datos procesados.}
...
Preservar la correlación es esencial: si los escenarios rompen dependencias, la covarianza sintética puede exagerar la diversificación. Por ello la comparación multmodelo incorpora error medio absoluto de correlación y la evaluación VAE incluye matrices reales y sintéticas.
