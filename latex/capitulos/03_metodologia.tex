...
\begin{itemize}
     \item Un término de regularización, que fuerza la distribución latente aproximada $q_{\phi}(z|x)$ a mantenerse cercana a la prior $p(z)$.
...
\section{Elección de la Cartera mediante la divergencia de Kullback-Leibler}
