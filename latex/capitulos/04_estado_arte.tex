...
A partir de estas ideas, el planteamiento inicial consideró una arquitectura VAE-GAN. Sin embargo, el desarrollo empírico alcanzado implementa el VAE y genera escenarios con su \textit{decoder}. La combinación adversaria se mantiene como ampliación futura, no como resultado experimental.
...
La revisión local se complementa con trabajos sobre aprendizaje profundo aplicado a carteras \cite{jiang2017deep,huang2020deep,zhang2020deep}, representación latente y generación \cite{opitz2017latent,voronina2025genai}, y validación cuantitativa \cite{lopez2018advances,lopezdeprado2018chapter1,rasekhschaffe2026}. Estas referencias ayudan a situar decisiones del pipeline, pero no sustituyen la comparación empírica realizada sobre los datos del TFM.
...
El hueco abordado se sitúa en la conexión entre generación de escenarios y optimización de carteras. La contribución empírica estudia un VAE aplicado a retornos del S\&P 500 y compara la cartera resultante con Markowitz y equiponderación. La extensión adversaria permitiría investigar posteriormente si mejora la fidelidad de colas y dependencias.
