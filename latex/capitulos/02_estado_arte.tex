...
Los modelos generativos permiten aprender directamente de la distribución subyacente de los datos, sin necesidad de supuestos previos. Este enfoque resulta especialmente útil para modelar colas pesadas, asimetrías y dependencias no lineales presentes en los precios de activos.
...
Las Redes Generativas Adversarias (GANs), introducidas en \cite{NIPS2016_8a3363ab}, son un tipo de modelos generativos que aprenden a generar datos realistas mediante un proceso de aprendizaje adversario.
...
El entrenamiento de las GANs consiste en encontrar un equilibrio de Nash para un juego de dos jugadores, el generador y el discriminador, en un escenario no cooperativo. 
