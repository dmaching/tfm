...
Aplicados al ámbito financiero, estos modelos pueden utilizarse para generar trayectorias sintéticas. En este trabajo se incluyen por su relevancia reciente, mientras la arquitectura experimental se limita al VAE. La referencia VAE-GAN corresponde a la inspiración conceptual y no a un modelo adversario entrenado.
