...
El proyecto utiliza datos financieros públicos y modelos de inteligencia artificial con finalidad académica. El marco relevante comprende protección de datos, condiciones de uso de la fuente, propiedad intelectual, transparencia y comunicación responsable. La ausencia de una aplicación comercial no elimina la necesidad de documentar procedencia y limitaciones.
...
El Reglamento General de Protección de Datos y la LOPDGDD establecen principios como minimización, limitación de finalidad y seguridad. Aunque los retornos corporativos utilizados no son datos personales, el proyecto adopta esos principios como buenas prácticas: solo almacena variables necesarias, separa credenciales del código y limita la finalidad a investigación y docencia.
...
Los modelos pueden producir resultados numéricamente precisos con una apariencia de objetividad que excede su validez. Por ello se documentan arquitectura, hiperparámetros, corte temporal y métricas, y se evita presentar una VAE-GAN que no fue entrenada. La transparencia sobre resultados negativos o limitaciones forma parte del uso responsable.
